...
CREATE TABLE `ayudantiasofertadas` (
  ...
  `requisitos` varchar(1000) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `estudiante` VALUES ('ljramos','jackieramosm','jackieramosm','dormir xD',NULL,NULL,NULL,1),('dschuldt','dschuldt','denkschuldt','astronomia',NULL,NULL,NULL,2),('davalbar','davalbar',NULL,'los video juegos',NULL,NULL,NULL,3),('hcarpio','hcarpio','verdecanibal','cantar',NULL,NULL,NULL,4);
...
INSERT INTO `supervisor` VALUES (1,'SIXTO ERNESTO','GARCIA AGUILAR','912456378','sgarcia@espol.edu.ec',NULL,''),(2,'CARLOS JOSEPH','MERA GOMEZ','0912345678','cjmera@espol.edu.ec',NULL,''),(3,'VICTOR MANUEL','ASANZA ARMIJOS','0912345678','vasanza@espol.ed.ec',NULL,''),(36,'JAVIER ALEJANDRO','TIBAU','0912345678','jtibau@espol.edu.ec',NULL,'');
...
-- Dump completed on 2014-08-10 19:02:54
